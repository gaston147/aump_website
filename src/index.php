...
<head> 
	...
	<title>Bluecraft - Kit graphique</title> 
...
<body>
    ...
    <div id="main-sidebar">
    	...
    	<h1>Découvrez notre nouveau site web !</h1>
    	<article>
    		<img src="images/img_mc1.jpg" alt="image minecraft">
    
    		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam tortor libero, mollis a vehicula id, tincidunt nec sem. Proin accumsan turpis sit amet nisi sollicitudin tincidunt. Quisque vitae sollicitudin dui, non aliquet nulla. Nulla sodales ultricies placerat. Aliquam congue eros sit amet viverra sollicitudin. Sed quam purus, iaculis vitae eleifend porta, luctus pharetra urna.</p>
		</article> 
        
        
        <h1>Découvrez notre nouveau site web !</h1>
    	<article>
    		<img src="images/img_mc2.jpg" alt="image minecraft">
   ...
   <div id="realisation">Kit graphique par <a href="http://weenox.com/">Weenox.com</a> et <a href="http://www.grafikmarket.fr/">Grafikmarket.fr</a></div>
